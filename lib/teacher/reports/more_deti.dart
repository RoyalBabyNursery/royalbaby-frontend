            ...
            child:
              ...
              Row(
                children: [
                  ...
                  Text('انشاء تقرير اضافي',
                      style: AppFonts.body2(color: NewColors.supHeading)),
                ],
              ),

              const SizedBox(height: 24),
              Text('نوع التقرير', style: AppFonts.body2(color: NewColors.label)),
              ...
              Text('ماذا حدث؟ (صف الحالة بإيجاز)',
                            ...
                            child: Row(
                              children: [
                                ...
                                Icon(Icons.calendar_today_outlined,
                                    size: 18, color: NewColors.placeHolder),
                              ],
                            ),
                          ),
                        ),
              ...
              const SizedBox(height: 18),
              Text('الجهة التي تم إخطارها (اختياري)',
                  style: AppFonts.body2(color: NewColors.supHeading)),
              const SizedBox(height: 8),
              Wrap(
                spacing: 8,
                children:
                    ['الإدارة', 'ولي الأمر', 'لم يتم الإبلاغ بعد'].map((option) {
                  return Row(
                    ...
                    children: [
                      Radio<String>(
                        ...
                        fillColor:
                            MaterialStateProperty.all(LineColors.radioStroke),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  SizedBox(height: 18,),
                  Text('ملاحظات إضافية (اختياري)',style: AppFonts.body2(color: NewColors.label),),
                      SizedBox(height: 8,),
                      NoteTextField(),
                      SizedBox(height: 48,),
                      InkWell(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 4),
                                        Text('تم انشاء التقرير الاضافي للطفل',
