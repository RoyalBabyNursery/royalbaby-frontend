...
class NoComment extends StatefulWidget {
  const NoComment({super.key});

  @override
  State<NoComment> createState() => _NoNotificationState();
}

class _NoNotificationState extends State<NoComment> {
  @override
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  children: [
                    Image.asset(
                      'assets/images/ResearchAnalysisReport.png',
                    ...
                    SizedBox(height: 8,),
                    Text(
                      'ستظهر تعليقات أولياء الأمور هنا عند توفرها',
