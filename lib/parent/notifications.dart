          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '• يشمل المهارات التي تم تدريب الأطفال عليها خلال الأسابيع الماضية.',
                  style: AppFonts.body2(color: NewColors.supHeading),
                ),
                Text(
                  '• يهدف إلى تعزيز التعلم من خلال الأنشطة المنزلية التفاعلية.',
                  style: AppFonts.body2(color: NewColors.supHeading),
                ),
                Text(
                  '• صُمم بطريقة مبسطة ومناسبة لكل مرحلة عمرية.',
                  style: AppFonts.body2(color: NewColors.supHeading),
                ),
                ...
                const SizedBox(height: 15),
                Text(
                  '• يرجى إعادة الواجب إلى الحضانة في موعد أقصاه يوم الخميس 23 يناير 2025.',
                  style: AppFonts.body2(color: NewColors.supHeading),
                ),
                const SizedBox(height: 20),
                Text(
                ...
                const SizedBox(height: 15),
                Text(
                  '• لا يشترط حل الواجب بشكل مثالي، بل الهدف هو التفاعل مع الطفل وتعزيز فهمه.',
                  style: AppFonts.body2(color: NewColors.supHeading),
                ),
                Text(
                  '• في حال وجود أي استفسار أو صعوبة، يمكنكم التواصل مع معلمة الصف.',
                  style: AppFonts.body2(color: NewColors.supHeading),
                ),
                SizedBox(height: 20),
                Text(
                  '💡 شكرًا لتعاونكم المستمر معنا في دعم العملية التعليمية لأطفالكم.',
                  style: AppFonts.body2(color: NewColors.supHeading),
                ),
              ],
            ),
