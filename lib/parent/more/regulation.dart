          ...
          child: Column(
            ...
            children: [
              ...
              RegulationHelp(
                title: 'الزي المناسب',
                note:
                    'ملابس مريحة وآمنة – يُفضل تجنب الإكسسوارات أو الأحذية المفتوحة',
              ),
              RegulationHelp(
                title: 'الوجبات',
                note:
                    'يرجى إرسال وجبة صحية يوميًا – لا يُسمح بالمأكولات الجاهزة أو الحلويات بكثرة',
              ),
              RegulationHelp(
                title: 'الغِياب والمرض',
                note:
                    'في حال الغياب أو وجود أعراض مرضية، نرجو الإبلاغ مبكرًا – لا يُسمح بالحضور أثناء الإصابة بأي عدوى',
              ),
              RegulationHelp(
                title: 'اصطحاب الألعاب',
                note:
                    'لا يُفضل إحضار ألعاب من المنزل – نحن نوفر بيئة آمنة ومناسبة للعب',
              ),
              RegulationHelp(
                title: 'الاستلام والتسليم',
                note:
                    'الطفل لا يُسلّم إلا لولي الأمر أو شخص مخوّل مسبقًا، مع إبراز الهوية',
              ),
              SizedBox(height: 12),
